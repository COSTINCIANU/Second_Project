...
{
    /**
     * @Route("/admin/commentcs", name="admin_commentC_index")
     */
    public function index(CommentCRepository $repo): Response
    {
        // $repo = $this->getDoctrine()->getRepository(CommentC::class);

        $commentCs = $repo->findAll();
